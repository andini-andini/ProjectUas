...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <a href="{{route('kamar.create')}}" class="btn btn-sm- btn-primary">Tambah Kamar</a>
        </div>
    </div>
    <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteKamarModalLabel">Konfirmasi Hapus Data</h5>
            ...
            <div class="modal-footer">
                ...
                <form id="form-delete-kamar" class="m-1">
                    @csrf
